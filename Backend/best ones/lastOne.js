...
async function scrapeUTMScholar() {
  ...
  // Step 3: Write the scraped data to a .json file
  const dataString = JSON.stringify(scrapedData, null, 2); // Pretty print the data
  fs.writeFileSync("scraped_scholar_data.json", dataString, "utf8");

  console.log("Scraped data saved to scraped_scholar_data.json");
